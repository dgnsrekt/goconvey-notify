...
const goconveyDSLImport = "github.com/dgnsrekt/goconvey-notify/convey " // note the trailing space: we don't want to target packages nested in the /convey package.
